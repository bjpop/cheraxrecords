...
Copyright   : (c) Bernie Pope, 2024 
License     : MIT 
Maintainer  : bjpope@unimelb.edu.au
Portability : POSIX

Generate the Cherax Records website 
'''
...
def parse_args():
    ...
    '''
    parser = ArgumentParser(description='Generate the Cherax Records website')
